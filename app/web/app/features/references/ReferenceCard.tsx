...
export default function ReferenceCard({
  ...
  return (
    <Card
      ...
      className="group cursor-pointer overflow-hidden rounded-2xl border border-white/10 bg-black/30 p-0 transition-all duration-300 hover:border-cyan-400/40"
    >
