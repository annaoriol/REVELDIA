...
export const REVEAL_AREAS: RevealArea[] = [
  {
    ...
    description: "Descubre quién eres realmente como marca.",
    specialist: "Director de Marca",
    prompt: "Analiza la identidad profunda de esta marca.",
    questions: [
      "¿Quién eres?",
...

  {
    ...
    description: "Encuentra el porqué de tu proyecto.",
    specialist: "Estratega",
    prompt: "Descubre el propósito auténtico del proyecto.",
    questions: [
      "¿Por qué existe?",
...

  {
    ...
    description: "Define el valor que aportas.",
    specialist: "Consultor",
    prompt: "Analiza la propuesta de valor.",
    questions: [
      "¿Qué ofreces?",
...

  {
    ...
    description: "Descubre cómo habla tu marca.",
    specialist: "Copywriter",
    prompt: "Define la voz y personalidad verbal.",
    questions: [
      "¿Cómo hablas?",
...

  {
    ...
    description: "Construye un lenguaje visual coherente.",
    specialist: "Director de Arte",
    prompt: "Define el universo visual.",
    questions: [
...

  {
    ...
    description: "Organiza cómo conectar con las personas.",
    specialist: "Director Creativo",
    prompt: "Diseña la estrategia de comunicación.",
    questions: [
      "¿A quién hablas?",
...

  {
    ...
    description: "Da forma a una idea completa.",
    specialist: "Project Lead",
    prompt: "Estructura el proyecto.",
    questions: [
...

  {
    ...
    description: "Convierte una intuición en una oportunidad.",
    specialist: "Creative Director",
    prompt: "Explora y desarrolla la idea.",
    questions: [
...
export function getRevealArea(
  id: string
): RevealArea | undefined {
